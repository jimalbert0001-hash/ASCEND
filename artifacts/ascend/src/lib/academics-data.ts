...
export const subjectsData: Subject[] = [
  {
    ...
    chapters: [
      ...
      blankChapter('phy-14', 'phy', 'Semiconductor Electronics: Materials, Devices & Simple Circuits', 14),
    ],
  },
  {
    id: 'chem',
    ...
    targetMarks: 95,
    chapters: [
      blankChapter('chem-1',  'chem', 'Physical Chemistry — Solutions', 1),
      blankChapter('chem-2',  'chem', 'Physical Chemistry — Electrochemistry', 2),
      blankChapter('chem-3',  'chem', 'Physical Chemistry — Chemical Kinetics', 3),
      blankChapter('chem-4',  'chem', 'Inorganic Chemistry — The d and f Block Elements', 4),
      blankChapter('chem-5',  'chem', 'Inorganic Chemistry — Coordination Compounds', 5),
      blankChapter('chem-6',  'chem', 'Organic Chemistry — Haloalkanes & Haloarenes', 6),
      blankChapter('chem-7',  'chem', 'Organic Chemistry — Alcohols, Phenols & Ethers', 7),
      blankChapter('chem-8',  'chem', 'Organic Chemistry — Aldehydes, Ketones & Carboxylic Acids', 8),
      blankChapter('chem-9',  'chem', 'Organic Chemistry — Amines', 9),
      blankChapter('chem-10', 'chem', 'Organic Chemistry — Biomolecules', 10),
    ],
  },
  {
    id: 'math',
  ...
  },
  {
    ...
    chapters: [
      ...
      blankChapter('cs-2',  'cs', 'Database Concepts', 2),
      blankChapter('cs-3',  'cs', 'Structured Query Language (SQL)', 3),
      blankChapter('cs-4',  'cs', 'Boolean Algebra', 4),
      blankChapter('cs-5',  'cs', 'Computer Hardware & Software', 5),
      blankChapter('cs-6',  'cs', 'Python — Functions & Modules', 6),
      blankChapter('cs-7',  'cs', 'Python — File Handling', 7),
      blankChapter('cs-8',  'cs', 'Python — Exception Handling', 8),
