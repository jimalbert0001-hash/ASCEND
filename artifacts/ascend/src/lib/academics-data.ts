...
export const subjectsData: Subject[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      blankChapter('eng-10', 'eng', 'Flamingo Poetry — An Elementary School Classroom in a Slum', 10),
      blankChapter('eng-11', 'eng', 'Flamingo Poetry — Keeping Quiet', 11),
      blankChapter('eng-12', 'eng', 'Flamingo Poetry — A Thing of Beauty', 12),
      blankChapter('eng-13', 'eng', 'Flamingo Poetry — A Roadside Stand', 13),
      blankChapter('eng-14', 'eng', 'Flamingo Poetry — Aunt Jennifer\'s Tigers', 14),
      blankChapter('eng-15', 'eng', 'Vistas — The Third Level', 15),
      blankChapter('eng-16', 'eng', 'Vistas — The Tiger King', 16),
      blankChapter('eng-17', 'eng', 'Vistas — Journey to the End of the Earth', 17),
      blankChapter('eng-18', 'eng', 'Vistas — The Enemy', 18),
      blankChapter('eng-19', 'eng', 'Vistas — On the Face of It', 19),
      blankChapter('eng-20', 'eng', 'Vistas — Memories of Childhood', 20),
      blankChapter('eng-21', 'eng', 'Vistas — The Interview', 21),
      blankChapter('eng-22', 'eng', 'Vistas — Evans Tries an O-level', 22),
      blankChapter('eng-23', 'eng', 'Writing Skills — Notice Writing', 23),
      blankChapter('eng-24', 'eng', 'Writing Skills — Letter Writing', 24),
      blankChapter('eng-25', 'eng', 'Writing Skills — Article Writing', 25),
      blankChapter('eng-26', 'eng', 'Writing Skills — Speech Writing', 26),
      blankChapter('eng-27', 'eng', 'Writing Skills — Paragraph Writing', 27),
    ],
  },
  {
    id: 'cs',
