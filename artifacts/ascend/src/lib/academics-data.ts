...
export const subjectsData: Subject[] = [
  ...
  },
  {
    ...
    targetMarks: 95,
    chapters: [
      blankChapter('chem-1',  'chem', 'Physical Chemistry — The Solid State', 1),
      blankChapter('chem-2',  'chem', 'Physical Chemistry — Solutions', 2),
      blankChapter('chem-3',  'chem', 'Physical Chemistry — Electrochemistry', 3),
      blankChapter('chem-4',  'chem', 'Physical Chemistry — Chemical Kinetics', 4),
      blankChapter('chem-5',  'chem', 'Physical Chemistry — Surface Chemistry', 5),
      blankChapter('chem-6',  'chem', 'Inorganic Chemistry — General Principles of Isolation of Elements', 6),
      blankChapter('chem-7',  'chem', 'Inorganic Chemistry — p-Block Elements', 7),
      blankChapter('chem-8',  'chem', 'Inorganic Chemistry — d & f Block Elements', 8),
      blankChapter('chem-9',  'chem', 'Inorganic Chemistry — Coordination Compounds', 9),
      blankChapter('chem-10', 'chem', 'Organic Chemistry — Haloalkanes & Haloarenes', 10),
      blankChapter('chem-11', 'chem', 'Organic Chemistry — Alcohols, Phenols & Ethers', 11),
      blankChapter('chem-12', 'chem', 'Organic Chemistry — Aldehydes, Ketones & Carboxylic Acids', 12),
      blankChapter('chem-13', 'chem', 'Organic Chemistry — Amines', 13),
      blankChapter('chem-14', 'chem', 'Organic Chemistry — Biomolecules', 14),
      blankChapter('chem-15', 'chem', 'Organic Chemistry — Polymers', 15),
      blankChapter('chem-16', 'chem', 'Organic Chemistry — Chemistry in Everyday Life', 16),
    ],
  },
  {
    id: 'math',
  ...
  },
  {
    ...
    targetMarks: 90,
    chapters: [
      blankChapter('eng-1',  'eng', 'Flamingo Prose — The Last Lesson', 1),
      blankChapter('eng-2',  'eng', 'Flamingo Prose — Lost Spring', 2),
      blankChapter('eng-3',  'eng', 'Flamingo Prose — Deep Water', 3),
      blankChapter('eng-4',  'eng', 'Flamingo Prose — The Rattrap', 4),
      blankChapter('eng-5',  'eng', 'Flamingo Prose — Indigo', 5),
      blankChapter('eng-6',  'eng', 'Flamingo Prose — Poets & Pancakes', 6),
      blankChapter('eng-7',  'eng', 'Flamingo Prose — The Interview', 7),
      blankChapter('eng-8',  'eng', 'Flamingo Prose — Going Places', 8),
      blankChapter('eng-9',  'eng', 'Flamingo Poetry — My Mother at Sixty Six', 9),
      blankChapter('eng-10', 'eng', 'Flamingo Poetry — Keeping Quiet', 10),
      blankChapter('eng-11', 'eng', 'Flamingo Poetry — A Thing of Beauty', 11),
      blankChapter('eng-12', 'eng', 'Flamingo Poetry — A Roadside Stand', 12),
      blankChapter('eng-13', 'eng', 'Flamingo Poetry — Aunt Jennifer\'s Tigers', 13),
      blankChapter('eng-14', 'eng', 'Vistas — The Third Level', 14),
      blankChapter('eng-15', 'eng', 'Vistas — The Tiger King', 15),
      blankChapter('eng-16', 'eng', 'Vistas — Journey to the End of the Earth', 16),
      blankChapter('eng-17', 'eng', 'Vistas — The Enemy', 17),
      blankChapter('eng-18', 'eng', 'Vistas — On the Face of It', 18),
      blankChapter('eng-19', 'eng', 'Vistas — Memories of Childhood', 19),
      blankChapter('eng-20', 'eng', 'Writing Skills — Notice Writing', 20),
      blankChapter('eng-21', 'eng', 'Writing Skills — Letter Writing', 21),
      blankChapter('eng-22', 'eng', 'Writing Skills — Article Writing', 22),
      blankChapter('eng-23', 'eng', 'Writing Skills — Report Writing', 23),
      blankChapter('eng-24', 'eng', 'Writing Skills — Speech Writing', 24),
    ],
  },
  {
    id: 'cs',
    ...
    targetMarks: 98,
    chapters: [
      blankChapter('cs-1',  'cs', 'Python Programming — Functions', 1),
      blankChapter('cs-2',  'cs', 'Python Programming — File Handling', 2),
      blankChapter('cs-3',  'cs', 'Python Programming — Exception Handling', 3),
      blankChapter('cs-4',  'cs', 'Python Programming — Data Structures', 4),
      blankChapter('cs-5',  'cs', 'Computer Networks — Networking Concepts', 5),
      blankChapter('cs-6',  'cs', 'Computer Networks — Network Security', 6),
      blankChapter('cs-7',  'cs', 'Database & SQL — Database Management', 7),
      blankChapter('cs-8',  'cs', 'Database & SQL — SQL Queries', 8),
      blankChapter('cs-9',  'cs', 'Societal Impact — Society, Law & Ethics', 9),
      blankChapter('cs-10', 'cs', 'Societal Impact — Boolean Algebra & Hardware', 10),
    ],
  },
];
